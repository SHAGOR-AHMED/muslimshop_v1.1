                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <img src="<?= base_url('assets/frontend/images/done.png');?>" class="img-responsive" style="width: 100%">
                                                        </div>
                                                        <div class="col-md-4"></div>
                                                    </div>
                                                    <div class="alert alert-block alert-success">
                                                        ...
                                                        Your order has been placed Successfully ! We'll Contact with you very soon.
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- panel-default -->
