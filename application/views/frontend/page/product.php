			...
			<div class="agileinfo-ads-display col-lg-9">
				<div class="wrapper">
					...
					<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
						<h3 class="heading-tittle text-center font-italic">All <?= $SubCat_name->subcategory; ?> Bikes</h3>
						<div class="row">

							<?php
								if(!empty($all_subcatproduct)){

								foreach ($all_subcatproduct as $products) {
